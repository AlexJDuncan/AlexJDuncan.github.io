...
const OverdriveOutfits = () => {
  return (
    <Container sx={{ display: "flex", flexFlow: "column", alignContent: "center", marginTop: "20px", marginBottom: "20px" }}>
      ...
      <img src={SizeQuantity} alt="Size and Quantity Selectors" style={{justifySelf: "center", marginBottom: "20px"}}/>
      <Box sx={{ marginBottom: "20px" }}>
        <Typography variant="body1" component="p" sx={{ marginBottom: "20px" }}>
      ...
      <img src={ProductDescription} alt="Product Description" style={{justifySelf: "center", marginBottom: "20px"}}/>
      <Box sx={{ marginBottom: "20px" }}>
        <Typography variant="body1" component="p">
